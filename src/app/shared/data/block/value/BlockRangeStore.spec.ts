...
import { BlockRangeStore } from "./BlockRangeStore";
import { ICache } from "app/util/cache/ICache";
import * as TypeMoq from "typemoq";
import { IBlockRangeApi } from "./IBlockRangeApi";
import { assertThrowsAsync } from "../../../../../../test/helper";
import { IGenericBlockData } from "./IGenericBlockData";
...
describe("data/" + BlockRangeStore.name, () => {
    function createStore() {
        ...
        return { blockRangeStore, cacheMock, rangeApiMock, pageSize };
    }
